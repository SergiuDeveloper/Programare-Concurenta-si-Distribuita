...
if __name__ == "__main__":
    ...
    tcp_start_timestamp, tcp_expected_bytes_count, tcp_chunks = tcp_client.run()
    ...
    tcp_stream_start_timestamp, tcp_stream_expected_bytes_count, tcp_stream_chunks = tcp_stream_client.run()
    ...
    udp_start_timestamp, udp_expected_bytes_count, udp_chunks = udp_client.run()
    ...
    udp_stream_start_timestamp, udp_stream_expected_bytes_count, udp_stream_chunks = udp_stream_client.run()
    ...
    print("Chunks:", tcp_stream_chunks)
    print()
    ...
    print("Chunks:", udp_stream_chunks)
    print()